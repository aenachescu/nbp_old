...
{
    NBP_CALL_TEST(check_ulong_eq);
    NBP_CALL_TEST(check_ulong_ne);
    NBP_CALL_TEST(check_ulong_gt);
    NBP_CALL_TEST(check_ulong_ge);
    NBP_CALL_TEST(check_ulong_lt);
    NBP_CALL_TEST(check_ulong_le);
}